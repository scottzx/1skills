...
const englishSkillsCopy = {
  inUse: {
    ...
    importModal: {
      ...
      description: "Scan folders for local skills and import them into the central store.",
      defaultFoldersLabel: "Default locations",
      addFolderLabel: "Add another folder",
      addFolderPlaceholder: "Absolute path, e.g. /Users/you/skills",
      add: "Add",
      remove: "Remove",
      scanning: "Scanning…",
      folderMissing: "Folder not found",
      folderEmpty: "No importable skills here",
      alreadyImported: "Already in store",
      linkedSkipped: (n: number) => `${n} symlinked skill${n === 1 ? "" : "s"} skipped`,
      selectAll: "Select all",
      importSelected: (n: number) => (n > 0 ? `Import ${n}` : "Import"),
      importing: "Importing…",
      cancel: "Cancel",
      emptyAll: "No local skill folders to import. Add a folder above.",
      loadError: "Unable to scan folders.",
      importedToast: (n: number) => `Imported ${n} skill${n === 1 ? "" : "s"}`,
      failedToast: "Some skills could not be imported.",
      browse: "Browse",
      picker: {
  ...
  versioning: {
    ...
    forkBadge: (version: number) => `⑂ fork · from v${version}`,
    mainBadge: "main",
    makeMain: "Make main",
    makingMain: "Making main",
    historyButton: (count: number) => `History (${count})`,
    historyDialogTitle: "Version history",
    historyDialogDescription: "Every recorded version of this skill, newest first.",
    close: "Close version history",
    currentVersion: "Current",
    restore: "Restore",
    restoring: "Restoring",
    noVersions: "No version history recorded yet.",
    unableToLoad: "Unable to load version history.",
    viewChanges: "View changes",
    compareAgainst: "Compare against",
    currentVersionOption: "Current version",
    noChanges: "No changes.",
    diffLoadError: "Unable to load the diff.",
    statusAdded: "Added",
  ...
  conflicts: {
    ...
    subtitle: (count: number) =>
      count > 0
        ? `${count} project push${count === 1 ? "" : "es"} waiting for adoption in Skills Manager.`
        : "No project pushes are waiting for adoption.",
    loading: "Loading pending pushes",
    unableToLoad: "Unable to load pending pushes.",
    emptyTitle: "No pending pushes",
    emptyBody: "Project pushes (new skills or updates) will show up here for you to accept or dismiss.",
    ...
    acceptCreate: "Accept into store",
    acceptingCreate: "Accepting",
    acceptUpdate: "Accept update",
    acceptingUpdate: "Accepting",
    makeMain: "Make main",
    makingMain: "Making main",
...
export const skillsCopy = {
  ...
  "zh-CN": {
    inUse: {
      ...
      importModal: {
        title: "导入 Skill 文件夹",
        description: "扫描文件夹中的本地 Skill，并导入到中央库统一管理。",
        defaultFoldersLabel: "默认位置",
        addFolderLabel: "添加其他文件夹",
        addFolderPlaceholder: "绝对路径，例如 /Users/you/skills",
        add: "添加",
        remove: "移除",
        scanning: "扫描中…",
        folderMissing: "文件夹不存在",
        folderEmpty: "这里没有可导入的 Skill",
        alreadyImported: "已在库中",
        linkedSkipped: (n: number) => `已跳过 ${n} 个软链接 Skill`,
        selectAll: "全选",
        importSelected: (n: number) => (n > 0 ? `导入 ${n} 个` : "导入"),
        importing: "导入中…",
        cancel: "取消",
        emptyAll: "没有可导入的本地 Skill 文件夹。请在上方添加文件夹。",
        loadError: "无法扫描文件夹。",
        importedToast: (n: number) => `已导入 ${n} 个 Skill`,
        failedToast: "部分 Skill 未能导入。",
        browse: "浏览",
        picker: {
          title: "选择文件夹",
          cancel: "取消",
    ...
    versioning: {
      versionBadge: (version: number) => `v${version}`,
      forkBadge: (version: number) => `⑂ 分叉 · 由 v${version} 而来`,
      mainBadge: "主版本",
      makeMain: "设为主版本",
      makingMain: "正在设为主版本",
      historyButton: (count: number) => `版本历史 (${count})`,
      historyDialogTitle: "版本历史",
      historyDialogDescription: "此 Skill 记录的所有版本，按最新排列。",
      close: "关闭版本历史",
      currentVersion: "当前",
      restore: "恢复",
      restoring: "正在恢复",
      noVersions: "还没有记录的版本历史。",
      unableToLoad: "无法加载版本历史。",
      viewChanges: "查看改动",
      compareAgainst: "对比版本",
      currentVersionOption: "当前版本",
      noChanges: "无改动。",
      diffLoadError: "无法加载改动内容。",
      statusAdded: "新增",
      statusRemoved: "删除",
      statusModified: "修改",
      source: {
    ...
    conflicts: {
      title: "待确认推送",
      subtitle: (count: number) =>
        count > 0 ? `有 ${count} 个项目推送等待在技能管理器中确认采纳。` : "暂无来自项目的待确认推送。",
      loading: "正在加载待确认推送",
      unableToLoad: "无法加载待确认推送。",
      emptyTitle: "没有待确认推送",
      emptyBody: "项目推送的新增或修改会显示在这里，由你决定是否纳入母体。",
      ...
      kindConflict: "冲突",
      acceptCreate: "采纳入库",
      acceptingCreate: "正在采纳",
      acceptUpdate: "采纳更新",
      acceptingUpdate: "正在采纳",
      makeMain: "设为主线",
      makingMain: "正在设为主线",
      saveAsFork: "存为分支",
      savingAsFork: "正在存为分支",
