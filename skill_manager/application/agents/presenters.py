...
from .inventory import AgentInventory, InventoryColumn, InventoryEntry, InventorySighting
from .policy import (
    attention_message,
    can_delete,
    can_manage,
...
def agents_page_payload(inventory: AgentInventory) -> dict[str, object]:
    counts = {
    ...
    *,
    ...
    return {
        ...
        "actions": {
            ...
            "stopManagingStatus": stop_managing_status(entry),
